        ...
        <div className="flex flex-col gap-8 py-10 md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/" aria-label="CornerSpan Home">
              <div className="flex h-14 w-14 items-center justify-center rounded-[18px] bg-gradient-to-br from-blue-600 to-indigo-700 text-2xl font-black text-white shadow-lg shadow-blue-600/20">
                C
              </div>
            </Link>
            ...
            <div>
              <Link
                href="/"
                className="text-2xl font-extrabold tracking-[-0.03em] text-slate-950"
              >
                CornerSpan
              </Link>
              ...
              <p className="mt-2 max-w-lg text-sm leading-6 text-slate-500">
                Accurate, practical and easy-to-use construction calculators
                for contractors, engineers, builders and homeowners.
              </p>
            </div>
          ...
          <div className="flex items-center gap-2">
            ...
            {socials.map((social) => (
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-xl border border-slate-200 text-slate-500 transition-all duration-200 hover:-translate-y-0.5 hover:border-blue-600 hover:bg-blue-600 hover:text-white hover:shadow-md"
              >
                {social.icon}
              </a>
            ))}
          ...
          >
            ...
            {footerLinks.map((link, index) => (
              <div key={link.name} className="flex items-center">
                ...
                <Link
                  href={link.href}
                  className="px-4 text-sm font-medium text-slate-600 transition-colors hover:text-blue-600"
                >
                  {link.name}
                </Link>
